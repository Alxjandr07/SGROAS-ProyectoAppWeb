...
Participaron 10 personas (P01--P10) anonimizadas, reclutadas por muestreo de conveniencia entre estudiantes y personal de la cooperativa. El perfil declarado incluye: 5 hombres y 5 mujeres, edades entre 20 y 45 años, experiencia web de nivel bajo a alto, y dispositivos mixture (escritorio y móvil). El tamaño muestral (n = 10) cumple la recomendación mínima de Kortum y Bangor \cite{kortum2013}. Los consentimientos informados se archivan fuera del repositorio público, conforme a \texttt{docs/etica/ETHICS.md}.
...
\begin{enumerate}
  \item Se ejecuta \texttt{./mvnw clean verify} que ejecuta las 150 pruebas JUnit 5 y genera el reporte JaCoCo.
