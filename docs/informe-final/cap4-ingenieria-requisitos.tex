...
Los 50 requisitos identificados se priorizaron mediante la técnica MoSCoW \cite{wiegers2013}, resultando en la distribución mostrada en la Tabla \ref{tab:moscow}:
...
Los resultados de la verificación se resumen en la Tabla \ref{tab:incose}:

\begin{table}[H]
\centering
\caption{Resumen de conformidad INCOSE C1--C15}
\label{tab:incose}
\begin{tabular}{lcc}
\toprule
