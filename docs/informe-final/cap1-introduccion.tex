...
\begin{enumerate}
  ...
  \item \textbf{Evidencia de calidad:} 150 pruebas JUnit 5 con JaCoCo núcleo 85,5\% líneas / 54,3\% ramas (67,5\% líneas full), escaneo OWASP ZAP baseline y pruebas de carga k6 (3 corridas, media 23,01\,ms, p95 máx 173,13\,ms).
