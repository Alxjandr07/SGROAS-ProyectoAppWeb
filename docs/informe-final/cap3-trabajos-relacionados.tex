...
\begin{enumerate}
  ...
  \item \textbf{Falta de reproducibilidad completa:} la mayoría de trabajos no publican datos crudos ni scripts de análisis. SGROAS cumple los principios FAIR \cite{fair2023} con datos versionados, scripts reproducibles y DOI de Zenodo.
\end{enumerate}
