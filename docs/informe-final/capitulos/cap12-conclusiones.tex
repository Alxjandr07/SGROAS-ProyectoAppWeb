...
\begin{itemize}
  ...
  \item \textbf{Usabilidad:} SUS 63.0 (IC\,95\,\% [53.07; 72.93]), clasificado como
        \emph{bueno} en zona marginal; por debajo del umbral de 70, por lo que se
        declara como mejora prioritaria.
  \item \textbf{Cobertura:} 99.7\,\% de líneas y 85.4\,\% de ramas con JaCoCo sobre
        150 pruebas JUnit, superando el umbral del proyecto.
