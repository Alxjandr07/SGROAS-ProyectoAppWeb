...
\begin{itemize}
  ...
  \item \textbf{Eficiencia de desempeño:} El p95 del listado de conductores es de 81,43 ms (umbral: 200 ms).
...
\begin{itemize}
  \item \textbf{Cobertura de pruebas (JaCoCo):} 98,8\% instrucciones, 85,4\% ramas, 99,7\% líneas.
