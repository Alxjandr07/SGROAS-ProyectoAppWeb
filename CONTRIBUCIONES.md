...
variable de entorno `JWT_SECRET` para el paso "Build and test" y el namespace de la
imagen con `${{ github.repository_owner }}`); incluye traducir los métodos de test al inglés, Javadoc
