...
imagen con `${{ github.repository_owner }}` y regenera `dataset/MANIFEST.sha256`
con los hashes reales de los reportes JaCoCo); incluye traducir los métodos de test al inglés, Javadoc
